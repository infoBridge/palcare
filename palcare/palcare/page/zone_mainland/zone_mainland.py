...
def main_visit_high():
    ...
    last_visit=[]
    patients=[]
    patients_visit_list=frappe.get_list("Visit Details",filters={"zone": 'Zone 6 - Mainland',"care_priority": 'High'},fields={"modified","patient","patient_name"},limit= 4)
...
@frappe.whitelist()
def main_visit_priority_medium():
    care_medium_patients_list=[]
    medium_visit_last_modified=[]
    last_visit_medium=[]
    care_medium_visit=frappe.get_list("Visit Details",filters={"zone": 'Zone 6 - Mainland'},fields={"modified","patient","patient_name","care_priority"},limit= 4)
...
@frappe.whitelist()
def main_visit_priority_low():
    care_low_patients_list=[]
    low_visit_last_modified=[]
    last_visit_low=[]
    care_low_visit=frappe.get_list("Visit Details",filters={"zone": 'Zone 6 - Mainland'},fields={"modified","patient","patient_name","care_priority"},limit= 4)
